...
def dispatch_pipeline(article_id: str) -> None:
    ...
    from workers.tasks.nlp.analyze_sentiment import run as analyze_sentiment_task
    from workers.tasks.nlp.cluster_article import run as cluster_article_task
    from workers.tasks.nlp.deduplicate import run as deduplicate_task
    from workers.tasks.nlp.embed_article import run as embed_article_task
    from workers.tasks.nlp.extract_entities import run as extract_entities_task
    from workers.tasks.nlp.normalize import run as normalize_task
