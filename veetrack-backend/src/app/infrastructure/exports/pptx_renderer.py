...
def _add_cover_slide(prs: object, layout: object, brief: BriefDocument) -> None:
    ...
    _add_text_box(
        ...
        left=Inches(0.8), top=Inches(2.4), width=Inches(11.7), height=Inches(0.9),
        font_size=Pt(36), bold=True, color=_WHITE,
    )
    _add_text_box(
        slide,
        f"{brief.entity_keyword}  ·  {brief.subtitle}",
        left=Inches(0.8), top=Inches(3.4), width=Inches(11.7), height=Inches(0.5),
        font_size=Pt(18), color=(148, 163, 184),
    )
    _add_text_box(
        slide,
        f"Last {brief.window_days} days  ·  Generated {date_str}",
        left=Inches(0.8), top=Inches(4.0), width=Inches(11.7), height=Inches(0.4),
        font_size=Pt(13), color=_SLATE,
    )
...
def _add_story_slide(
    ...
    _add_text_box(
        slide,
        f"{idx} / {total}",
        left=Inches(11.8), top=Inches(0.15), width=Inches(1.4), height=Inches(0.3),
        font_size=Pt(10), color=_SLATE,
    )
    ...
    _add_text_box(
        ...
        left=Inches(0.5), top=Inches(0.18), width=Inches(6), height=Inches(0.3),
        font_size=Pt(10), bold=True, color=risk_rgb,
    )
    ...
    _add_text_box(
        slide,
        story.title,
        left=Inches(0.5), top=Inches(0.55), width=Inches(12.3), height=Inches(0.8),
        font_size=Pt(22), bold=True, color=_BODY,
    )

    # What happened
    _add_text_box(
        slide, "What Happened",
        left=Inches(0.5), top=Inches(1.5), width=Inches(5.8), height=Inches(0.28),
        font_size=Pt(9), bold=True, color=_SLATE,
    )
    _add_text_box(
        slide,
        story.what_happened or "Analysis pending.",
        left=Inches(0.5), top=Inches(1.82), width=Inches(5.8), height=Inches(2.1),
        font_size=Pt(12), color=_BODY, wrap=True,
    )

    # Why it happened
    _add_text_box(
        slide, "Why It Happened",
        left=Inches(6.9), top=Inches(1.5), width=Inches(5.9), height=Inches(0.28),
        font_size=Pt(9), bold=True, color=_SLATE,
    )
    _add_text_box(
        slide,
        story.why_happened or "Analysis pending.",
        left=Inches(6.9), top=Inches(1.82), width=Inches(5.9), height=Inches(2.1),
        font_size=Pt(12), color=_BODY, wrap=True,
    )
    ...
    if story.top_recommendation:
        _add_text_box(
            slide, "Recommended Action",
            left=Inches(0.5), top=Inches(4.2), width=Inches(12.3), height=Inches(0.25),
            font_size=Pt(9), bold=True, color=_SLATE,
        )
        _add_text_box(
            slide,
            story.top_recommendation,
            left=Inches(0.5), top=Inches(4.5), width=Inches(12.3), height=Inches(0.8),
            font_size=Pt(13), color=_BODY, wrap=True,
        )
...
def _add_closing_slide(prs: object, layout: object) -> None:
    ...
    _add_text_box(
        ...
        left=Inches(1.5), top=Inches(2.8), width=Inches(10.3), height=Inches(1.5),
        font_size=Pt(16), color=(148, 163, 184),
    )
    _add_text_box(
        slide, "VeeTrack",
        left=Inches(1.5), top=Inches(4.5), width=Inches(4), height=Inches(0.4),
        font_size=Pt(14), color=_SLATE,
    )
