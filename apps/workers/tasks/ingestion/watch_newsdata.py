...
from connectors.base import CircuitOpen, RateLimitExceeded, RedisRateLimiter
from connectors.newsdata import NewsDataClient, RawArticle
...
async def _run_pull(
    ...
    for aid in new_article_ids:
        from tasks.nlp.pipeline_orchestrator import dispatch_pipeline
