...
def test_ping_task_writes_timestamp_to_redis() -> None:
    ...
    import tasks.system.ping as ping_mod

    with mock.patch("tasks.system.ping.redis_sync.from_url", return_value=fake):
...
def test_ping_task_retries_on_redis_error() -> None:
    ...
    with mock.patch("tasks.system.ping.redis_sync.from_url", side_effect=flaky_from_url):
