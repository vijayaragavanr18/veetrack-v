...
from observability import init_worker_sentry, register_celery_signals
...
app = Celery(
    ...
    include=[
        ...
        "tasks.llm",
        "tasks.alerts",
        "tasks.exports.scheduled_digest",
        "tasks.search",
        "tasks.system.ping",
    ],
)
...
app.conf.update(
    ...
    task_routes={
        ...
        "tasks.system.*": {"queue": "ingestion"},  # system tasks share the ingestion queue
    },
    ...
    beat_schedule={
        ...
        "nightly-recluster": {
            "task": "tasks.nlp.clustering.full_recluster",  # Phase 15
